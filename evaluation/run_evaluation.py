...
import json
import os
from task_05_graph_evaluation_print_error import compare_segmentation_to_ground_truth_skeleton, test_upgrades
...
def format_parameter_configs(config):
    ...
    skeleton_configs['with_interpolation'] = config['Input']['with_interpolation']
...
def run_evaluation(
    ...
    #     num_processes,
    #     parameter_configs)
    test_upgrades(config['Input']['segment_dataset'], config['Input']['segment_volumes'], parameter_configs)
