...
def predict_blockwise(
    ...
    command = prepare_command(experiment,
            setup,
            iteration,
            raw_file,
            raw_dataset,
    ...
    # logging.info("Actor launch command is {}".format(command))
    ...
    succeeded = daisy.run_blockwise(
        ...
        block_read_roi,
        block_write_roi,
        process_function=lambda: subprocess.run(command),
