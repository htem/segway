...
with viewer.txn() as s:
    ...
    gt_tools.add_ng_layer(s, daisy.open_ds(f, 'volumes/segmentation_slice_z_0.100/'), 'zseg_100')
    gt_tools.add_ng_layer(s, daisy.open_ds(f, 'volumes/segmentation_slice_z_0.900/'), 'zseg_900')
