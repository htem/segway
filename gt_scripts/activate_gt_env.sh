...
alias drop_database="python ${segway_dir}/tools/mongodb_remove_database_for.py ${gt_json}"
...
alias 06_check_all="python -i ${segway_dir}/gt_scripts/ng_check_gt_pre_final.py ${gt_json}"
